...
import { AdminAlumniList } from "@features/alumni/components/AdminAlumniList";
import AlumniEditModal from "@features/alumni/components/AlumniEditModal";
import AlumniCreateModal from "@features/alumni/components/AlumniCreateModal";
import AlumniFormModal, {
  AlumniForm,
} from "@features/alumni/components/AlumniFormModal";
  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      <header className="mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold">Alumni Network</h1>
      ...
      <section className="mb-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 gap-4 sm:gap-0">
          ...
          >
            <span className="hidden sm:inline">Create Alumni</span>
