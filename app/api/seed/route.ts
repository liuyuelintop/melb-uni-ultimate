...
const sampleAlumni = [
  ...
  {
    name: "Alex Kim",
    email: "alex.kim@alumni.unimelb.edu.au",
    studentId: "65432109",
    graduationYear: 2019,
    ...
    company: "Meta",
    achievements: [
      "International Ultimate Frisbee Representative",
  ...
  {
    name: "Sophie Brown",
    email: "sophie.brown@alumni.unimelb.edu.au",
    studentId: "54321098",
    graduationYear: 2022,
    ...
    achievements: [
      ...
      "Best Handler Award 2020",
      "Leadership Excellence Award",
    ],
    contactPreference: "phone" as const,
    phoneNumber: "+61 400 111 222",
    linkedinUrl: "https://linkedin.com/in/sophiebrown",
    isActive: true,
    createdBy: "admin",
    updatedBy: "admin",
  },
  {
    name: "Tom Anderson",
    email: "tom.anderson@alumni.unimelb.edu.au",
    studentId: "43210987",
    graduationYear: 2018,
    ...
    achievements: [
      "National Team Captain 2017",
      "University Sports Person of the Year",
