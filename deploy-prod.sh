...
echo "   The public /api/seed endpoint has been removed — it was callable"
echo "   without authentication and wiped every collection. Create the admin"
echo "   directly against the database, then set its role to 'admin'."
echo ""
echo "5. 🔒 SECURITY: rotate any credential that was ever committed to this repo."
